...
(function webpackMissingModule() { throw new Error("Cannot find module \"webpack-server\""); }());
...
// 函数
/*function worthless(){
	console.log("Webpack is really good!");
}
module.exports = worthless();*/

var people = [{ name: "Henry", age: 18 }, { name: "Bucky", age: 20 }, { name: "Emily", age: 17 }, { name: "Elyse", age: 18 }];
